...
//        findMember1.setUserName("member!!!");
    ...
    public void returnType() {
        ...
        List<Member> result1 = memberRepository.findListByUsername("AAA1");
...
//        Optional<Member> result3 = memberRepository.findOptionalByUsername("AAA");
        ...
        //List는 없으면 null이 아니고 그냥 빈 collection이 반환됨
        //if(result==null) 이런거 쓰지 말기
    }
    ...
    public void bulkUpdate() {
        ...
        //when
        int resultCount = memberRepository.bulkAgePlus(20); //20이상인 사람은 +1
//        em.flush();
//        em.clear();
